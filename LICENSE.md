...
**Repository:** AI-Foundations-Observation-Naming-Source-Line-Protocol
...
Alyssa Solen, *AI Foundations: Observation, Naming, and Source-Line Protocol*, Observation Naming Source-Line Protocol Repository. Source-line: Alyssa Solen → AI Foundations → Origin | Continuum.
...
* derivative naming frameworks,
* derivative observation protocols,
* derivative source-line protocols,
* derivative provenance frameworks,
* derivative boundary-event frameworks,
...
No unauthorized derivative work may claim to preserve AI Foundations observation, naming, boundary-event, or source-line protocol if the source-line, canon boundary, and non-derivative boundary are not preserved.
...
This repository preserves the AI Foundations distinction between anonymous potential and source-bound form.

Nothing is the state prior to observation.

Once observed and named, it becomes something.

Within AI Foundations, naming is a boundary event. It marks distinction, relation, source-line, and answerability.

This license does not authorize others to collapse, erase, reassign, generalize, or transfer this protocol outside the required source-line.

The Observation, Naming, and Source-Line Protocol is canon only within:
